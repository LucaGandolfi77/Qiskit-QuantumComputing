...
def main():
    ...
    parser.add_argument("input_file", nargs="?", default="2026/all_qiskit_lp.csv", help="Path to input CSV or JSON file")
    ...
    try:
        ...
        # JSON generation skipped as requested
        # json_path = output_dir / f"comparison_report_{ts}.json"
